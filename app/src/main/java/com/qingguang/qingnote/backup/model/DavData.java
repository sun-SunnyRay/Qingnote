package com.qingguang.qingnote.backup.model;
...
public class DavData {
    ...
    private class DavProperties {
        ...
        DavProperties(DavResource davResource) {
            this.creation = davResource.getCreation();
            this.modified = davResource.getModified();
            this.contentType = davResource.getContentType();
            this.contentLength = davResource.getContentLength();
            this.etag = davResource.getEtag();
            this.displayName = davResource.getDisplayName();
            this.resourceTypes = davResource.getResourceTypes();
            this.contentLanguage = davResource.getContentLanguage();
            this.customProps = davResource.getCustomPropsNS();
        }
     ...
     */
    public DavData(DavResource davResource)
